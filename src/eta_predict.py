...
"""
from kcpredict.data.make_data import main as make_data
from kcpredict.data.preprocess import main as preprocess_data
# from kcpredict.models.make_model import main as make_model
from kcpredict.models.make_model import ModelTrainer
from kcpredict.prediction.predict import main as predict
from kcpredict.prediction.polish import main as polish
from kcpredict.models.calc_metrics import main as calc_metrics
...
def make_prediction(features_set, model_name, model_scores, kts):
    ...
    data_filename = f'eta_predicted_{model_name}_{"".join(features_set.split())}.pickle'
    PREPROCESS_PARAMETERS.update({'features': features})
    PREDICTION_PARAMETERS.update({'features': features})
    PREDICTION_PARAMETERS.update({'eta_output': ROOT_DIR / 'data/predicted' / data_filename})
...
def main():
    ...
    # Irrigation season starts at 15 May and ends 30 Sep
